...
let b:undo_ftplugin .= '|setlocal foldtext='.s:save_foldtext
      ...
      \ . '|delcommand NvimPamDoc'
      \ . '|delcommand NvimPamAddLineComment'
      \ . '|delcommand NvimPamAddCardComments'
      \ . '|delcommand NvimPamSelectCard'
      \ . '|delcommand NvimPamAlignLine'
      \ . '|delcommand NvimPamAlignCard'
