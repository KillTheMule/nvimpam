...
pub static OTMCO: Card = Card {
  lines: &[
    ...
    Block(
      &[
        Cells(&[Blank(8), Fixed(FixedStr::Weight), Float(0, WTFAC)]),
        Ges(GesNode),
      ],
      b"END_OTMCO",
    ),
...
// TODO(KillTheMule): Is this all correct for Rbodies? Type goes by ITRB
...
// TODO(KillTheMule): Need to check IT3FL on the last line
